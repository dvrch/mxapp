<script lang="ts">
    ...
    onMount(() => {
      ...
      const renderer = new THREE.WebGLRenderer({ canvas, alpha: true }); // Ajout de alpha: true pour rendre le fond transparent
      ...
      scene.background = null; // Cette ligne définit le fond de la scène comme transparent
